...
##### Seperation of bundles

It is beneficial to seperate application, vendor and polyfills code in the bundles for easier error tracing and segregation of responsibilities in the bundles: 
...
Im using CommonsChunkPlugin to seperate the bundles by simply registrering in the plugins section of a webpack config:
...
- [ ] Bundles are compressed with gzip (preferable serverside)
